...
public static class SystemVariablesUtils
{
    ...
    public static bool IsExistVariable(string name) => GetVariable(name) is not null;
    ...
    class SystemVariablesCollection
    {
        ...
        public static SystemVariablesCollection Parse(string text) => new(text.Split(';', StringSplitOptions.RemoveEmptyEntries));
    }
}